...
if __name__ == "__main__":
    ...
    if sendWindows:
        ...
        # assumption that this is executed at root level of repo
        ...
        dictList = []
        # Iterate through each window and send web request to Statuspage with data to create each Scheduled Maintenance.
        for window in schedule_windows:
